sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("NAMESPACE/Cash_Box/app", ".html");
		...
		return Opa5.extend("NAMESPACE.Cash_Box.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["NAMESPACE/Cash_Box/localService/mockserver"], function (mockserver) {
